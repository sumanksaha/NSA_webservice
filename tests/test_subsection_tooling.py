...
class TestClausePropagation:
    ...
    def test_fills_fragments_after_clause_boundary(self):
        docs = self._doc([
            ...
            },
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(1) Biscuits shall be made from",
                "hierarchy_level": 3,
            },
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(a) plain flour only",
                "hierarchy_level": 4,
            },
        ])
    ...
    def test_never_overwrites_existing_clause_number(self):
        docs = self._doc([
            ...
            },
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(1) Biscuits shall be",
                "hierarchy_level": 3,
                "clause_number": "3.04",
            },
        ])
    ...
    def test_resets_at_structural_boundary(self):
        docs = self._doc([
            ...
            {"document_id": "doc-1", "document_type": "regulation", "chunk_text": "SCHEDULE 2", "hierarchy_level": 1},
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(1) Fees for analysis",
                "hierarchy_level": 2,
            },
        ])
        out = derive_clause_propagation(docs)
    ...
    def test_reset_markers(self, marker):
        docs = self._doc([
            ...
            {"document_id": "doc-1", "document_type": "regulation", "chunk_text": marker, "hierarchy_level": 1},
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(1) Something new",
                "hierarchy_level": 2,
            },
        ])
        assert derive_clause_propagation(docs) == {}
        ...
        docs = self._doc([
            {
                "document_id": "doc-1",
                "document_type": "act",
                "chunk_text": "2.4.15 Some Act clause",
                "hierarchy_level": 3,
            },
            {"document_id": "doc-1", "document_type": "act", "chunk_text": "(1) Fragment", "hierarchy_level": 3},
        ])
        assert derive_clause_propagation(docs) == {}
    ...
    def test_hl1_fragments_not_filled(self):
        docs = self._doc([
            ...
            {"document_id": "doc-1", "document_type": "regulation", "chunk_text": "Address:", "hierarchy_level": 1},
        ])
        assert derive_clause_propagation(docs) == {}
        ...
        docs = self._doc([
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "(1) Preamble fragment",
                "hierarchy_level": 2,
            },
        ])
        assert derive_clause_propagation(docs) == {}
        ...
        docs = self._doc([
            {
                "document_id": "doc-1",
                "document_type": "regulation",
                "chunk_text": "2.1.1 Registration of Petty Food Business",
                "hierarchy_level": 3,
            },
            {
                "document_id": "doc-1",
    ...
    def test_document_type_scope_configurable(self):
        docs = self._doc([
            {"document_id": "doc-1", "document_type": "rule", "chunk_text": "1.2.3 Rule heading", "hierarchy_level": 3},
            {"document_id": "doc-1", "document_type": "rule", "chunk_text": "(1) Sub-rule", "hierarchy_level": 3},
        ])
...
class TestStripRegSectionNoise:
    ...
    def test_strips_regulation(self):
        assert derive_strip({"document_type": "regulation", "section_number": "41"}) == {"section_number": None}

    def test_strips_notification(self):
        assert derive_strip({"document_type": "notification", "section_number": "4"}) == {"section_number": None}
    ...
    def test_strips_rule_by_default(self):
        ...
        # since 2026-08-18.
        assert derive_strip({"document_type": "rule", "section_number": "161"}) == {"section_number": None}

    def test_scope_restrictable(self):
        # passing an explicit tuple restricts the strip; rule is untouched.
        assert derive_strip({"document_type": "rule", "section_number": "161"}, ("regulation", "notification")) is None
