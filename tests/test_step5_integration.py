...
from app.models import Sample, Inspection, CaseFile, Adjudication, FSO
...
class TestSampleLookupEndpoint:
    ...
    def test_lookup_sample_endpoint(self, test_client):
        ...
        with test_client.application.app_context():
            ...
            response = test_client.get(
                '/case_file_generator/lookup_sample?sample_code=LOOKUP001'
            )
    ...
    def test_lookup_sample_not_found(self, test_client):
        ...
        response = test_client.get(
            '/case_file_generator/lookup_sample?sample_code=NONEXISTENT'
        )
