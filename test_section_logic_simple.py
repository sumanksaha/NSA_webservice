...
def test_section_logic():
    ...
    print("  Expected: ['51']")
    print("  Result: {}".format(sections_1))
    assert sections_1 == ['51'], "Expected ['51'], got {}".format(sections_1)
    print("  PASSED")
    ...
    print("  Expected: ['52']")
    print("  Result: {}".format(sections_2))
    assert sections_2 == ['52'], "Expected ['52'], got {}".format(sections_2)
    print("  PASSED")
    ...
    print("  Result: {}".format(sections_3))
    assert sections_3 == ['51', '52'], "Expected ['51', '52'], got {}".format(sections_3)
    print("  PASSED")
    ...
    print("  Expected: []")
    print("  Result: {}".format(sections_4))
    assert sections_4 == [], "Expected [], got {}".format(sections_4)
    print("  PASSED")
