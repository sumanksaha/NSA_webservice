...
├── tests/                        # 90+ pytest modules, 1,757 test cases (collected 2026-08-20)
...
```bash
python -m pytest tests/ -v          # full suite (1,757 tests collected 2026-08-20)
